...
declare type CoreColumnDefBase<TData extends RowData, TValue> = {
    ...
    header?: ColumnDefTemplate<ReturnType<CoreHeader<TData, TValue>['getContext']>>;
    footer?: ColumnDefTemplate<ReturnType<CoreHeader<TData, TValue>['getContext']>>;
...
declare type CoreColumnDefDisplayWithStringHeader<TData extends RowData, TValue> = CoreColumnDefBase<TData, TValue> & {
    header: string;
    id?: string;
};
declare type CoreColumnDefAccessorFn<TData extends RowData, TValue = unknown> = CoreColumnDefBase<TData, TValue> & {
...
declare type ColumnDef<TData extends RowData, TValue extends any = unknown> = CoreColumnDef<TData, TValue> & VisibilityColumnDef & ColumnPinningColumnDef & FiltersColumnDef<TData> & SortingColumnDef<TData> & GroupingColumnDef<TData, TValue> & ColumnSizingColumnDef;
declare type Column<TData extends RowData, TValue> = CoreColumn<TData, TValue> & VisibilityColumn & ColumnPinningColumn & FiltersColumn<TData> & SortingColumn<TData> & GroupingColumn<TData> & ColumnSizingColumn;
