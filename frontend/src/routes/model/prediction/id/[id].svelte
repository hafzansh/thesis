...
>
	...
	<div class="stat place-items-center">
		...
		<div class="flex flex-row justify-center gap-2">
			...
			<a href="#send-mail" class="flex flex-col justify-center items-center">
				<div class="stat-value text-white mb-1 mt-1 text-[25px]">
					<Fa icon={faShare} />
				</div>
							...
							<div class="form-control">
								<label class="label cursor-pointer">
									<input
										type="radio"
										name="radio-6"
										class="radio {form_modal === '1' ? 'radio-primary' : ''}"
										value="1"
										on:change={onChange}
									...
									<span
										class="label-text btn {form_modal === '1'
											? 'btn-primary'
											: ''} text-white w-80">Badan Pusat Statistik Kal-Sel</span
									>
								</label>
							</div>
							<div class="form-control">
								<label class="label cursor-pointer">
									<input
										type="radio"
										name="radio-6"
										class="radio {form_modal === '2' ? 'radio-primary' : ''}"
										value="2"
										on:change={onChange}
										bind:group={form_modal}
									...
									<span
										class="label-text btn {form_modal === '2'
											? 'btn-primary'
											: ''} text-white w-80">Dinas Tanaman Pangan Kal-Sel</span
									>
								</label>
							</div>
							<div class="form-control">
								<label class="label cursor-pointer">
									<input
										type="radio"
										name="radio-6"
										class="radio {form_modal === '3' ? 'radio-primary' : ''}"
										value="3"
										on:change={onChange}
										bind:group={form_modal}
							...
							{#if form_modal == '3'}
								<div class="form-control w-full" in:fade out:fade>
									<label class="label" for="">
										<span class="label-text">Masukkan Alamat E-Mail Tujuan</span
										>
									</label>
									<input
										type="email"
