...
<div class="mockup-window border bg-slate-300 h-[85vh]">
  <div class="flex flex-row h-full w-full">
    <div class="w-10/12 h-[75vh]" in:fly={{ x: 500, duration: 1000 }}>
      {#if steps == 1}
        <div transition:slide class="bg-slate-600 m-5 h-full rounded-lg">
          <div class="flex flex-col justify-center items-center w-full h-full">
            <article class="prose mx-10 text-slate-300 items-start">
              <h1 class="text-slate-300">CSV Column Format</h1>
              <p />
              <!-- ... -->
            </article>
            <div class="flex flex-row">
              <div class="flex flex-col">
                <article class="prose mx-10 mb-5 text-slate-300 items-start">
                  <h2 class="text-slate-300"># Example</h2>
                  <!-- ... -->
                </article>
                <img
                ...
                />
                <article class="prose mx-10 mt-5 text-slate-300 items-start">
                  <h2 class="text-slate-300"># Format Stasiun</h2>
                  <!-- ... -->
                </article>
              ...
              <div class="flex flex-col">
                <article class="prose mb-5 text-slate-300 items-start">
                  <h2 class="text-slate-300"># Format Kota</h2>
                  <!-- ... -->
                </article>
      ...
      {/if}
      {#if steps == 4}
        <div transition:slide class="bg-amber-300 m-5 h-full rounded-lg">
